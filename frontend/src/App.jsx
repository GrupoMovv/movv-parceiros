...
const MarketplacePet = lazy(() => import('./pages/public/Marketplace/MarketplacePet'));
  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route path="/marketplace/pet"            element={<MarketplaceFallback><MarketplacePet /></MarketplaceFallback>} />
