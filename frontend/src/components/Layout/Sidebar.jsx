...
import {
  ...
  Landmark, Gift, MessagesSquare, Contact, Inbox, Store, Bell, UserCheck, Crown, Wine, Bike,
} from 'lucide-react';
...
const MASTER_MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Base SECI',        icon: Landmark,      to: '/sindicato/base-seci',       roles: ['sindicato_aprendiz', 'admin'] },
