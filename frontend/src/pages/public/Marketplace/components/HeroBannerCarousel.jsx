...
// / 400-450 desktop), sem relação com o Fecha Mês. Hero/Jogos/Serviços/Food
...
// próprio em ./heroSlides. Ordem: Hero, Jogos, Serviços, Food, Fecha Mês,
...
export default function HeroBannerCarousel({ fechaMesInfo }) {
  ...
  // principal (posição 1); antes disso fica na posição 5 (depois do Food).
