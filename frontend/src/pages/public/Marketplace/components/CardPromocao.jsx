    ...
    >
      <div className="relative w-full h-[130px] sm:h-[150px] xl:h-[180px] rounded-lg overflow-hidden bg-white flex items-center justify-center">
        ...
        {(contagem || vagasRestantes !== null) && (
          <span className="absolute bottom-1.5 left-1.5 right-1.5 text-[10px] font-bold text-center px-1.5 py-0.5 rounded text-white truncate" style={{ backgroundColor: 'rgba(15,15,20,0.75)' }}>
      ...
      <div className="pt-2 flex-1 flex flex-col">
        <p className="text-xs text-gray-500 truncate">{promocao.parceiro_nome}</p>
