...
async function montarViewAssociado(associado) {
  ...
  return {
    ...
    receber_whatsapp: associado.receber_whatsapp,
    receber_email: associado.receber_email,
    empresa: empresaNome,
    empresa_editavel: associado.empresa_id ? null : associado.empresa_nome_livre,
